...
$query = mysqli_query($conn,"select * from technical_user where username = '$username' and password = '$password' and firstname = '$firstname' and password = '$password' ")or die(mysqli_error());
...
mysqli_query($conn,"insert into technical_user (username,password,firstname,lastname,thumbnails) values('$username','$password','$firstname','$lastname','images/NO-IMAGE-AVAILABLE.jpg')")or die(mysqli_error());

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add Guest User $firstname $lastname')")or die(mysqli_error());
?>
<script>
