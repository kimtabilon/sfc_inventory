...
mysqli_query($conn,"update user set username = '$username'  , firstname = '$firstname' , middlename = '$middlename', lastname = '$lastname' where user_id = '$get_id' ")or die(mysqli_error());
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname $lastname')")or die(mysqli_error());	
?>
<script>
