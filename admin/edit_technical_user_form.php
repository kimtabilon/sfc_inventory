	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($conn,"select * from technical_user where tech_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($conn,"update technical_user set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where tech_id = '$get_id' ")or die(mysqli_error());

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Technical User $firstname $lastname')")or die(mysqli_error());	
?>
<script>
