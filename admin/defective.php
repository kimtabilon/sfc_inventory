        ...
        <div class="container-fluid">
            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
		                        ...
		                        where release_status='Returned' and item_status = 'Defective' and remarks=' / Brand new' ORDER BY release_details.release_details_id DESC")or die(mysqli_error());
...
<tr>
		...
		<td><?php
			   ...
			   where release_status='Returned' and item_status = 'Defective' and remarks=' / Brand new'")or die(mysqli_error());
